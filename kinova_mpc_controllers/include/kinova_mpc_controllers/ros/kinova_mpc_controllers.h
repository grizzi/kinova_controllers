...
class KinovaMpcControllerSim
    : public KinovaMpcControllerRos<kinova_controllers::MPC_VelocityController> {
 protected:
...
class KinovaMpcControllerRobotPositionVelocity : public KinovaMpcControllerRobot<MPC_VelocityController>{};
class KinovaMpcControllerRobotPositionTorque : public KinovaMpcControllerRobotTorque<MPC_VelocityController>{};
class KinovaMpcControllerRobotAdmittanceVelocity : public KinovaMpcControllerRobot<MPC_AdmittanceController>{};
class KinovaMpcControllerRobotAdmittanceTorque : public KinovaMpcControllerRobotTorque<MPC_AdmittanceController>{};
